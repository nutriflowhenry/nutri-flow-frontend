                    ...
                    <div className="flex-1 flex bg-white rounded-xl shadow-sm overflow-hidden">
                        ...
                        <div className="hidden md:flex flex-col items-center justify-end w-48 bg-[#F4EAE0] p-4">
                            <div className="relative w-full h-64">
                                <img
                                    src="https://i.imgur.com/3CN3lJG.png"
                                    alt="NutriBot"
                                ...
                                />
                                <div className="absolute inset-0 flex items-center justify-center bg-[#F4EAE0] rounded-full">
                                    <FaRobot className="text-4xl text-[#6b8f71]" />
                                </div>
                            </div>
